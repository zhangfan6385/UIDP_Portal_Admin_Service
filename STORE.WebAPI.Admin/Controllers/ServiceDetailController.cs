         ...
         public IActionResult PostFile([FromForm]IFormCollection formCollection,string serviceId,string creater,string fileType,string fileName)
        {
            ...
            try
            {
                ...
                foreach (IFormFile file in fileCollection)
                {
                    ...
                    String filename = System.IO.Directory.GetCurrentDirectory() + "\\UploadFiles\\service\\" + Guid.NewGuid().ToString() + suffix;
                    ...
                    d["FILE_URL"] = @"\\UploadFiles\\service\\" + Guid.NewGuid().ToString() + suffix;
